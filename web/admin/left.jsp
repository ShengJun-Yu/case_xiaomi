...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            ...
            <%--   点击用户管理 请求到userServlet 携带mark用来匹配方法         --%>
            <li><cite></cite><a href="<%=basePath %>admin/userServlet?mark=pageQuery"
                                target="rightFrame">用户管理</a><i></i></li>
            <li><cite></cite>
                <a href="<%=basePath %>admin/categoryServlet?mark=pageQuery" target="rightFrame">商品类别管理</a><i></i></li>
            <li><cite></cite>
                <a href="<%=basePath %>admin/commodityServlet?mark=pageQuery"
